...
export const metadata: Metadata = {
  ...
  description: 'Production-grade personal ledger, run-rate forecasting, multimodal OCR receipt verifier, and DPS compounding engine for salaried professionals in Dhaka.',
};
